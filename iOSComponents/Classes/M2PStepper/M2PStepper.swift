...
/* checkStepper.setUpStepper(stepperType: .withoutCount)
 
 checkStepperWithCount.setUpStepper(stepperType: .withCount, colorSet: StepperColorSetup(stepperBGColor: .backgroundLightVarient, buttonBGColor: .clear, buttonTextColor: .secondaryInactive, selectButtonBGColor: .white, selectButtonTextColor: .secondaryRedColor, countLableBGColor: .background, countLableTextColor: .primaryActive))
 
 checkStepper.onClick = { (isPluseTap, Count) in
...
public class StepperColorSetup {
...
public class M2PStepper: UIView {
    ...
    var count = 0
    var withCount = false
    var stepperColorSetup: StepperColorSetup?
    ...
    public func setUpStepper(stepperType: StepperType, colorSet: StepperColorSetup = StepperColorSetup(stepperBGColor: .backgroundLightVarient, buttonBGColor: .clear, buttonTextColor: .secondaryInactive, selectButtonBGColor: .white, selectButtonTextColor: .secondaryRedColor, countLableBGColor: .borderDefault, countLableTextColor: .primaryActive)) {
